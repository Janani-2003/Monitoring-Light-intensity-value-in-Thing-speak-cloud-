...
#define ldr_pin 34
char ssid[] = "Galaxy F55";   // your network SSID (name) 
char pass[] = "vinoli@12";   // your network password
int keyIndex = 0;            // your network key Index number (needed only for WEP)
WiFiClient  client;

unsigned long myChannelNumber = 2797247 ;
const int ChannelField = 1;
const char * myWriteAPIKey = "G5CIPCEMEQKZ1X56";
